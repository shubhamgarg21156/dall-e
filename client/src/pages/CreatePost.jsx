...
const CreatePost = () => {
  ...
  const generateImg = async () => {
      if(form.prompt){
          try{
            ...
            const response = await fetch('https://dall-e-5uvs.onrender.com/api/v1/dalle' , {
              method:'POST',
              headers:{
            ...
            setForm({...form,photo:`data:image/jpeg;base64,${data.photo}`})
             ...
             alert("Please Enter a different prompt");
          }finally{
  ...
  const handleSubmit = async (e) => {
      ...
      if(form.prompt && form.photo){
        ...
        try{
            const response = await fetch("https://dall-e-5uvs.onrender.com/api/v1/post",{
              method:"POST",
              headers:{
                "Content-type":"application/json",
              },
    ...
    <section className='max-w-7xl m-auto'>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
         ...
         <div className='mt-10'>
              ...
              <button type="submit" className='mt-3 text-white bg-[#6469ff] text-sm w-full font-medium rounded-md sm:w-auto px-5 py-2.5 text-center'>
